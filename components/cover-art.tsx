...
export function CoverArt({
  ...
  return (
    <div
      aria-hidden
      className={`${className} flex items-center justify-center border border-zinc-200/70 bg-gradient-to-br from-violet-500/15 via-violet-500/5 to-transparent font-semibold text-zinc-400/80 select-none`}
    >
